...
$document->addStyleSheet(JURI::base() . 'modules/mod_jv_headline/assets/css/jv_sello1.css');
$document->addScript(JURI::base() . 'modules/mod_jv_headline/assets/js/jv_sello1.js');
...
<div class="jv_slide6_wrap">
    <div class="jv_lslide6_wrap" style="<?php echo $leftWidth.";".$cssSlideImgHeight; ?>">
        <div class="slide_img_wrap" id="slide_image<?php echo $moduleId; ?>" style="<?php echo $cssSlideImgHeight; ?>">
