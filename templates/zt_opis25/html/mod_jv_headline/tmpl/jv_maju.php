...
$document->addStyleSheet(JURI::base() . 'modules/mod_jv_headline/assets/css/jv_maju.css');
$document->addScript(JURI::base() . 'modules/mod_jv_headline/assets/js/jv_maju.js');
...
<div class="jv-majuheadline-wrapper" style="<?php echo $cssWidth; ?>">
    <div class="jv-proshowwrap">
        <div class="jv-proshow" style="<?php echo $cssWidth.";".$cssHeight;?>" id="jv_slideshow5_<?php echo $module->id; ?>">
            <?php
			$i=0;
