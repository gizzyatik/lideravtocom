...
$document->addStyleSheet(JURI::base() . 'modules/mod_jv_headline/assets/css/zt_iner.css');
$document->addScript(JURI::base() . 'modules/mod_jv_headline/assets/js/zt_iner.js');
...
<script type="text/javascript">
    var startSlideshow<?php echo $module->id; ?> = function() {
        var mySlideShow8<?php echo $module->id; ?>  = new ZTInerslide({
        ...
        <div class="jv-pedonheadline-group">
		   ...
		   <?php } ?>
			<?php foreach($list as $item) {//Set menu ?>
				...
				<?php if($item->thumbs) { ?>
				<img class="png" src="<?php echo $item->imageintro; ?>" alt="image" />
