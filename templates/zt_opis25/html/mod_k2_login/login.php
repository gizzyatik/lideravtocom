	...
	<form action="<?php echo JRoute::_( 'index.php', true, $params->get('usesecure')); ?>" method="post" name="login" id="form-login" >
	  ...
	  <fieldset class="input">
	    <p id="form-login-username">
	      <input id="modlgn_username" type="text" name="username" class="inputbox" size="25" />
	    </p>
	    <p id="form-login-password">
	      <input id="modlgn_passwd" type="password" name="<?php echo (K2_JVERSION=='16') ? 'password':'passwd'?>" class="inputbox" size="25" />
	    </p>
